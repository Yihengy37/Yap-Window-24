...
#check-btn, #new-game-btn, #show-solution-btn {
  padding: 10px 20px;
  margin: 5px;
  background-color: var(--button-bg);
  border: none;
...
#check-btn:hover, #new-game-btn:hover, #show-solution-btn:hover {
  background-color: var(--button-hover);
}
...
<div id="game-window">
    ...
    <div id="game-content">
      ...
      <button id="new-game-btn">New Numbers</button>
      <button id="show-solution-btn">Show Solution</button>
      
      <div id="message"></div>
      
      <div id="stats">
        <div>Solved: <span id="solved-count">0</span></div>
